...
$packageName= 'ViDi-DC' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://dvorkin.by/downloads/ViDi-DC_setup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'ViDi-DC*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
